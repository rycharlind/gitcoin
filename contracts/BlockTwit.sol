...
contract BlockTwit is owned, tokenRecipient {
    ...
    function sendTwit(string _message, address _to) {
        Message(msg.sender, _to, _message);
    }

    /* First time setup */
    function GitAssociation(token sharesAddress, uint minimumSharesToPassAVote, uint minutesForDebate) payable {
